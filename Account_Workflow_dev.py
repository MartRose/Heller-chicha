...
print ("Log Location:                     logs/"+site+"_Account_Workflow_dev_" + timestamp + ".log")
print "########################################################################################"
...
class TC(unittest.TestCase):
    def setUp(self):
        ...
        command_executor='http://' + grid + ':4444/wd/hub',
            ...
            'browserName': 'chrome',
            'name': ''+site+'_Account_Workflow_dev_'+timestamp+'', #Update this to reflect the test case name
    ...
    def test_case(self):
        ...
        signin_name = "moomy.bone@mailinator.com"
        signin_blank.click()
        signin_blank.clear()
        ...
        driver.find_element_by_name("email").send_keys("moomy.new@mailinator.com")
        ...
        old_add_blank = driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Address'])[2]/following::input[1]")
        new_str_add = "1552 Jennifer Dr"
        old_add_blank.click()
        old_add_blank.clear()
        for character in new_str_add:
            old_add_blank.send_keys(character)
            time.sleep(0.3)
