...
env =    config.get('test_config','env')
...
print ("Log Location:                     logs/"+site+"_Account_Workflow_qa_" + timestamp + ".log")
print "########################################################################################"
...
class TC(unittest.TestCase):
    def setUp(self):
        ...
        command_executor='http://' + grid + ':4444/wd/hub',
            ...
            'browserName': 'chrome',
            'name': ''+site+'_Account_Workflow_qa_'+timestamp+'', #Update this to reflect the test case name
    ...
    def test_case(self):
        ...
        signin_name = "uripides.lola@mailinator.com"
        signin_blank.click()
        signin_blank.clear()
